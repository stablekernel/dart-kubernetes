...
import 'package:kubernetes/definitions/io/k8s/api/settings/v1alpha1/PodPresetSpec.dart';
import 'package:kubernetes/base.dart';

class PodPreset extends Codable {
  PodPreset();
  ...
  void decode(Coder decoder) {
    ...
    spec = decoder.decode('spec', inflate: () => new PodPresetSpec.empty());
}
