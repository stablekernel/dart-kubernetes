...
import 'package:kubernetes/definitions/io/k8s/api/extensions/v1beta1/NetworkPolicySpec.dart';
import 'package:kubernetes/base.dart';

class NetworkPolicy extends Codable {
  NetworkPolicy();
  ...
  void decode(Coder decoder) {
    ...
    spec = decoder.decode('spec', inflate: () => new NetworkPolicySpec.empty());
}
