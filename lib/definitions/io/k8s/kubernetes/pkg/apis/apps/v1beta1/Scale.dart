...
import 'package:kubernetes/definitions/io/k8s/api/apps/v1beta1/ScaleSpec.dart';
import 'package:kubernetes/definitions/io/k8s/api/apps/v1beta1/ScaleStatus.dart';
