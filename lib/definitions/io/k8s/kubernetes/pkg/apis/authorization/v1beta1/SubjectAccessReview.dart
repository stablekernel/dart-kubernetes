...
import 'package:kubernetes/definitions/io/k8s/api/authorization/v1beta1/SubjectAccessReviewSpec.dart';
import 'package:kubernetes/definitions/io/k8s/api/authorization/v1beta1/SubjectAccessReviewStatus.dart';
import 'package:kubernetes/base.dart';

class SubjectAccessReview extends Codable {
  SubjectAccessReview(this.spec);

  SubjectAccessReview.empty();
