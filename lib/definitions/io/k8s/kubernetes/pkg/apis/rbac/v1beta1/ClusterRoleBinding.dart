...
import 'package:kubernetes/definitions/io/k8s/api/rbac/v1beta1/RoleRef.dart';
import 'package:kubernetes/definitions/io/k8s/api/rbac/v1beta1/Subject.dart';
import 'package:kubernetes/base.dart';

class ClusterRoleBinding extends Codable {
  ClusterRoleBinding(this.subjects, this.roleRef);

  ClusterRoleBinding.empty();
