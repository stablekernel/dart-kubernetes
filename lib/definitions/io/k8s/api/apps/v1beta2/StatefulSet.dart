...
import 'package:kubernetes/definitions/io/k8s/api/apps/v1beta2/StatefulSetSpec.dart';
import 'package:kubernetes/definitions/io/k8s/api/apps/v1beta2/StatefulSetStatus.dart';
