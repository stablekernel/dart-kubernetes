...
import 'package:kubernetes/definitions/io/k8s/api/apps/v1beta2/DeploymentSpec.dart';
import 'package:kubernetes/definitions/io/k8s/api/apps/v1beta2/DeploymentStatus.dart';
