...
import 'package:kubernetes/definitions/io/k8s/api/apps/v1beta2/ScaleSpec.dart';
import 'package:kubernetes/definitions/io/k8s/api/apps/v1beta2/ScaleStatus.dart';
