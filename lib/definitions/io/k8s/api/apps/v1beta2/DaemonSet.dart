...
import 'package:kubernetes/definitions/io/k8s/api/apps/v1beta2/DaemonSetSpec.dart';
import 'package:kubernetes/definitions/io/k8s/api/apps/v1beta2/DaemonSetStatus.dart';
