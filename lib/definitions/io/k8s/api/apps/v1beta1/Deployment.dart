...
import 'package:kubernetes/definitions/io/k8s/api/apps/v1beta1/DeploymentSpec.dart';
import 'package:kubernetes/definitions/io/k8s/api/apps/v1beta1/DeploymentStatus.dart';
