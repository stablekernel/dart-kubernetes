import 'package:kubernetes/definitions/io/k8s/api/core/v1/Endpoints.dart';
import 'package:kubernetes/definitions/io/k8s/apimachinery/pkg/apis/meta/v1/ListMeta.dart';
import 'package:kubernetes/base.dart';

class EndpointsList extends Codable {
  EndpointsList(this.items);
  ...
  void decode(Coder decoder) {
    ...
    items = decoder.decodeObjects('items', () => new Endpoints.empty());
